...
all linear layers include trainable bias terms.  The default device is cuda:1.
...
def main() -> None:
    ...
    summary = {
        "experiment_type": "fixed_left_edge_5x5_cloth_activation_depth_width_ablation",
        "use_bias": USE_BIAS,
        "runtime_config": asdict(config),
        "physical_config": asdict(physical),
        "motion_split": asdict(motion_split),
