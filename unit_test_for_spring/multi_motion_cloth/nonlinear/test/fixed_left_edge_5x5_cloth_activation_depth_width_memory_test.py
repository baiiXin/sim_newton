...
def worker_run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    try:
        ...
        # Warmup allocates Adam states and CUDA kernels before the measured step.
    ...
    except Exception as exc:  # keep parent scan alive and preserve the error
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="PYTORCH_CUDA_ALLOC_CONF used by each worker subprocess.",
    )
    parser.add_argument(
        "--continue-after-oom",
        action="store_true",
