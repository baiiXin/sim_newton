...
all linear layers include bias.  The default device is cuda:1.
    ...
    report = {
        ...
        "model": {
            ...
            "linear_bias_initialization": (
                "PyTorch nn.Linear default uniform initialization; "
                "bias is enabled for every linear layer in this experiment"
            ),
