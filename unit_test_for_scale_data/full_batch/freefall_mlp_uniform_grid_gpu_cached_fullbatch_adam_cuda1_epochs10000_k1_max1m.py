"""
自由落体单帧变分问题：规则网格 Full-Batch 训练数据规模消融实验（Adam）
====================================================
    ...
    report = {
        "config": {
            ...
            "grid_storage": (
                ...
                "on the training device. The three Adam learning-rate experiments "
...
def main() -> None:
    ...
    overall_report = {
        ...
        "grid_storage": (
            ...
            "chunks on the training device, reuse it for the three Adam learning-rate "
