...
def main():
    ...
    # 对 y0 做与 dt 同量级的高斯扰动，增加 15 个训练初值
    perturb_std = DT_PERTURB_STD_SCALE * dt
    y0_perturbations = torch.randn(
    ...
    training_initial_points = [
        y0,
        *[y0 + perturbation for perturbation in y0_perturbations],
    ]
    ...
    report = {
        "config": {
            ...
            "y0": y0.tolist(),
            "y0_perturbations": y0_perturbations.tolist(),
            "training_initial_points": [
                point.tolist()
