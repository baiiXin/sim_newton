"""
自由落体单帧变分问题：加速度变量迭代版规则网格 Full-Batch 训练数据规模消融实验（float32 全优化器对照）
====================================================
...
3. 所有张量、模型参数、梯度和优化器状态使用 torch.float32；
...
# float32 对照实验：完整测试 SGD/Adam × 三种学习率。
OPTIMIZER_CONFIGS = [
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default="cuda:1",
        help="Training device, for example: cpu, cuda, cuda:1, cuda:1.",
    )
    parser.add_argument(
        "--skip-contour",
        action="store_true",
