...
def run_experiment(
    ...
    # --------------------------------------------------------
    # 9.5 最终测试：统一从参考初值 y0 出发，MLP vs Newton
    # --------------------------------------------------------
...
def main():
    ...
    ablation_summary = {
        ...
        "comparison_principle": (
            ...
            "normalization, and output dt scaling. SGD uses lr=1e-2 without "
            "momentum; Adam uses lr=1e-4. For each optimizer, sigma is scanned "
            "over 1e-1, 1e-2, 1e-3, 1e-4, and 1e-5."
        ),
